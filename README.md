...
* [jetztencrypt-v0.2-app.jar](https://jitpack.io/com/github/pottedplant/jetztencrypt/v0.2/jetztencrypt-v0.2-app.jar)
...
```
java -jar jetztencrypt-v0.2-app.jar --help
```

### Quick and Dirty (privileged user)

```
java -jar jetztencrypt-v0.2-app.jar \
